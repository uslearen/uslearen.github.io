---
title: Anglish Runic Font
---

As part of creating a book I had a requirement for an easy to use runic font. Since I didn’t find anything suitable for my needs I created one. The font is in a usable state, so I decided to make it available to the general public.

# Anglish Runic Font

## Overview

The Anglish Runic Font is designed for transliteration of Modern English written in Latin script to Modern English written in Runic script.
...
[Please click on this link to download, after download double click the file to let your operating system install it.](AnglishNotoSansRegular.ttf)
...
Even though the consensus is that ᛢ is made up, it is the closest I can get to an 'attested' form so for practical purposes for me that is sufficient.
...
For the punctuation marks, I just tried to give it some relative meaning and commonality with modern punctuations. The justification being that punctuation is even in the latin characterset a relative recent invention too.
